...
import { _ as g } from './TextInput-11c61ab0.js';
import './iconify-c502b4ab.js';
const o = u({
  __name: 'EmailInput',
  props: {
    size: {},
      ...
      (e, v) => (
        ...
        f(
          g,
          {
            ...
            icon: e.icon ? 'material-symbols:alternate-email-rounded' : null,
            preset: e.preset,
            disabled: e.disabled,
            message: e.message,
            state: e.state,
...
o.__docgenInfo = {
  ...
  description: '',
  tags: {},
  props: [{ name: 'icon', defaultValue: { func: !1, value: 'true' } }],
  events: [{ name: 'updateValue', type: { names: ['string'] } }],
  sourceFiles: [
    'C:/Users/datse/Documents/Code/NewProjects/s1kebeats/s1kebeats_ui/src/components/EmailInput/EmailInput.vue'
  ]
};
const E = { component: o },
  b = [null, 'success', 'error'],
  y = ['sm', 'md', 'lg', 'xl'],
  n = () =>
    s('div', { class: 'inline-grid grid-cols-2 gap-5' }, [
      b.map((a) =>
        s('div', { class: 'flex flex-col gap-5 items-start' }, [
          y.map((t) =>
            s('div', { class: 'flex items-center gap-5' }, [
              s(o, { name: 'input', state: a, size: t, key: t + a }, null),
              s(
                o,
                { icon: !1, name: 'input', state: a, size: t, key: t + a },
                null
              )
            ])
          )
...
export { n as Presentation, V as __namedExportsOrder, E as default };
