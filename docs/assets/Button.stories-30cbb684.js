...
import { L as C } from './LoadingSpinner-4abcabaa.js';
import { I as S } from './iconify-c502b4ab.js';
const s = z({
  __name: 'Button',
  props: {
    size: { default: 'md' },
  ...
  setup(t) {
    ...
    return (o, _) => (
      ...
      v(
        ...
        {
          class: d([
            'relative flex items-center justify-center link transition-all disabled:cursor-not-allowed',
            [g.value, x.value]
          ])
        },
        [
                ...
                ? (u(),
                  p(
                    k(S),
                    {
                      ...
                      icon: o.icon,
                      class: d([B.value, { 'opacity-0': o.loading }])
                    },
                    null,
                    8,
                    ['icon', 'class']
...
s.__docgenInfo = {
  ...
  props: [
    ...
    { name: 'type', defaultValue: { func: !1, value: "'primary'" } },
    { name: 'position', defaultValue: { func: !1, value: "'left'" } },
    { name: 'loading', defaultValue: { func: !1, value: 'false' } }
  ],
  slots: [{ name: 'default' }],
  sourceFiles: [
    'C:/Users/datse/Documents/Code/NewProjects/s1kebeats/s1kebeats_ui/src/components/Button/Button.vue'
  ]
};
const j = { component: s },
  w = ['primary', 'secondary', 'subtle', 'ghost'],
  V = ['sm', 'md', 'lg', 'xl'],
  l = () =>
    a('div', { class: 'grid gap-5' }, [
      w.map((t) =>
        a('div', { class: 'flex flex-col gap-5 items-start' }, [
          V.map((e) =>
            a('div', { class: 'flex gap-5' }, [
              a(
                s,
                {
              ...
              a(
                s,
                { type: t, size: e, key: e + t },
                { default: () => [n('Button')] }
              ),
              a(
                s,
                { loading: !0, type: t, size: e, key: e + t },
                { default: () => [n('Button')] }
              ),
              a(
                s,
...
l.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: `() => <div class="grid gap-5">\r
    ...
    return <div class="flex flex-col gap-5 items-start">\r
      ...
      ...((f = (m = l.parameters) == null ? void 0 : m.docs) == null
        ? void 0
        : f.source)
    }
  }
...
export { l as Presentation, E as __namedExportsOrder, j as default };
